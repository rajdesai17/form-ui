...
function App() {
  ...
  return (
    <div>
      ...
      <div className="flex justify-center items-center min-h-screen bg-gradient-to-b from-blue-400 to-blue-200 pt-20"> {/* Add gradient background and padding */}
        <div className="flex max-w-4xl w-full bg-white shadow-md rounded-lg overflow-hidden"> {/* Set a fixed maximum width and flex container */}
